...
const SIGNAL_EXPLANATIONS: Record<SignalType, SignalExplanationContent> = {
  ...
  square: {
    ...
    signalIdea: "Switches between +A and -A based on the duty cycle.",
  },
  triangle: {
    title: "Triangle Wave",
    ...
    signalIdea: "Ramps linearly between -A and +A.",
  },
  sawtooth: {
    title: "Sawtooth Wave",
    ...
    signalIdea: "Ramps from -A to +A, then resets.",
  },
  pulse: {
    title: "Pulse Wave",
    ...
    signalIdea: "Switches between 0 and A based on the duty cycle.",
  },
};
